...
class _ProfilePageNewState extends State<ProfilePageNew> {
  ...
  Future<dynamic> getCatalogue(context, bool isArtisan) async {
    Future<dynamic> catalogue;
    var network = Provider.of<WebServices>(context, listen: false);
    if (isArtisan) {
      catalogue = network.getServiceImage(network.userId, network.userId);
      catalogue.then((data) {
        catalogueCount = data.length;
      });
    } else
      catalogue =
          catalogue = network.getProductImage(network.userId, network.userId);
    catalogue.then((data) {
      catalogueCount = data.length;
    });
        ...
        body: FutureBuilder(
            ...
            builder: (context, snapshot) {
              ...
              if (!snapshot.hasData) {
                ...
                bool isArtisan =
                    snapshot.data['role'] == 'artisan' ? true : false;
                headWidget = Column(children: [
                        ...
                        Stack(children: <Widget>[
                          ...
                          Positioned(
                            ...
                            child: Container(
                              ...
                              child: snapshot.data['identificationStatus'] ==
                                      'un-verified'
                                  ? SizedBox()
                                  : Icon(
                                      Icons.check,
                  ...
                  Padding(
                      ...
                      child: Column(children: [
                        ...
                        snapshot.data['subServices'][0]['subservice'] == null ||
                        ...
                        Tab(
                            child: Text('Catalogue($catalogueCount)',
                                style: GoogleFonts.openSans(
                                    ...
                                    fontWeight: FontWeight.w600))),
                        Tab(
                            child: Text('Reviews(${snapshot.data['reviews']})',
                                style: GoogleFonts.openSans(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w600))),
                      ],
                        ...
                        children: [
                          ...
                          Container(
                            child: snapshot.data['role'] == 'artisan'
                                ? FutureBuilder(
                                    future: getCatalogue(context, isArtisan),
                                    builder: (context, snapshot) {
                                      Widget mainWidget;
                          ...
                          StatefulBuilder(builder:
                            ...
                            return FutureBuilder(
                                future:
                                    network.getArtisanReviews(network.userId),
                                builder: (context, snapshot) {
                                  Widget mainWidget;
                                  if (snapshot.connectionState ==
                                      ConnectionState.done) {
