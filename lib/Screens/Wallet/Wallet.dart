...
import 'package:fixme/Screens/Wallet/WalletPay.dart';
import 'package:fixme/Screens/Wallet/WalletFund.dart';
import 'package:fixme/Screens/Wallet/WalletWithdraw.dart';
import 'package:fixme/Screens/Wallet/WalletAddCard.dart';
import 'package:fixme/Screens/Wallet/WalletHistory.dart';
import 'package:fixme/Screens/Wallet/Providers/WalletProvider.dart';
...
class _WalletState extends State<Wallet> {
                                    ...
                                    children: <Widget>[
                                      ...
                                      Row(
                                        ...
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.only(top: 5),
                                            child: Text('\₦${userBankInfo.balance}',
                                                style: TextStyle(
                                                    color: Colors.white,
                                                    fontSize: 24,
                                                    fontFamily: 'Firesans',
                                    ...
                                    Navigator.of(context).push(
                                      PageRouteBuilder(
                                        pageBuilder:
                                          ...
                                          return WalletPay(userBankInfo: model.userBankInfo);
                                        },
                                  ...
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      PageRouteBuilder(
                                        pageBuilder:
                                            (context, animation, secondaryAnimation) {
                                          return WalletFund(userBankInfo: model.userBankInfo);
                                        },
                                        transitionsBuilder: (context, animation,
                                            secondaryAnimation, child) {
                                          return FadeTransition(
                                  ...
                                  onPressed: () {
                                    Navigator.of(context).push(
                                      PageRouteBuilder(
                                        pageBuilder:
                                            (context, animation, secondaryAnimation) {
                                          return WalletWithdraw(userBankInfo: model.userBankInfo);
                                        },
                                        transitionsBuilder: (context, animation,
                                            secondaryAnimation, child) {
                                          return FadeTransition(
  ...
  Widget buildTransactionText(String type, String amount, String currency,BuildContext context) {
    var utils = Provider.of<Utils>(context);
    Widget text;
    switch (type) {
      case "credit":
        text = Text('+ ${utils.currencySymbol(currency)}$amount',
            style: TextStyle(
                fontFamily: 'Firesans',
                fontSize: 17,
