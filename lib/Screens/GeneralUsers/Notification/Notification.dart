                              ...
                              return Container(
                                child: ListView.builder(
                                  itemBuilder: (context, index) {
                                    var date =
                                        data.compareDate(users[index].createdAt);
                                    return Material(
                                      color: Colors.white,
                                      elevation: 1,
                                      child: Container(
                                                              ...
                                                              : users[index]
                                                                  ...
                                                                  : users[index]
                                                                      ...
                                                                      ? Container(
                                                                          ...
                                                                          child: Center(
                                                                              child:
                                                                                  Text('CONFIRMED', style: TextStyle(fontSize: 13, color: Color(0xFFA40C85), fontWeight: FontWeight.w500))),
                                                                          decoration: BoxDecoration(
                                                                              border:
                                                              ...
                                                              (context) => [
                                                                    PopupMenuItem(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () {
                                                                            FirebaseApi.deleteNotification(
                                                                                users[index].id);
                                                                            Navigator.pop(
                                                                                context);
                                                                          },
