...
class _BidderPageState extends State<BidderPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Material(
        child: FutureBuilder(
            future: network.getUserJobInfo(widget.data.project_owner_user_id, widget.data.bidder_id),
                  ...
                  children: [
                    ...
                    FutureBuilder(
                        future: network.getServiceImage(
                            network.user_id, snapshot.data.id),
                        builder: (context, snapshot) {
                          return Column(
                            crossAxisAlignment:
                    ...
                    StatefulBuilder(
                        builder: (BuildContext context, StateSetter setStates) {
                          return FutureBuilder(
                              future: network.getArtisanReviews(snapshot.data.id),
                              builder: (context, snapshot){
