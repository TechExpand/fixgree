      ...
      body: WillPopScope(
        ...
        child: Container(
          child: Column(
            children: [
              FutureBuilder(
                  future: network.getEventTickets(context),
                    ...
                    //      )
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          List myEvents = snapshot.data.reversed.toList();
                          return Padding(
                                    ...
                                    children: [
                                            ...
                                            child: ClipRRect(
                                                ...
                                                child: Image.network(
                                                  'https://uploads.fixme.ng/thumbnails/' +
                                                      myEvents[index]['event_info']['eventImages'][
                                                      0]['imageFileName'].toString(),
                                                  fit: BoxFit.cover,
                                                ))),
                                      ),
                                      SizedBox(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                            ...
                                            child: Wrap(
                                              children: [
                                               ...
                                               Builder(builder: (context){
                                                 for(var value in myEvents[index]['event_info']['event_tickets']) {
                                                   return Text(
                                          ...
                                          Text(myEvents[index]['event_info']
                                              ['event_begin_date'].toString()),
                                         // Text(snapshot.data[0]['referenceToken'].toString()),
                                          Container(
                                            padding: EdgeInsets.only(
                                                top: 4,
                                                bottom: 10,
                                                ...
                                                Navigator.push(
                                                  ...
                                                  PageRouteBuilder(
                                                    pageBuilder: (context,
                                                      ...
                                                      return
                                                        Barcode(
                                                          refToken: myEvents[index]['referenceToken'].toString(),
                                                        );
                                                    },
                                                    transitionsBuilder:
                                                        (context,
