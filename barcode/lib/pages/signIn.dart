...
import 'package:barcode/pages/home.dart';
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Padding(
                  padding:
                      const EdgeInsets.only(bottom: 20.0, top: 14, left: 20),
                  child: Text(
                    'Password',
                    style: TextStyle(
                      color: Colors.purple,
                ...
                Padding(
                  padding: const EdgeInsets.only(
                      bottom: 20.0, top: 14, left: 20, right: 20),
                  child: Text(
                    'Forget Password?',
                    style: TextStyle(
                      color: Colors.orange,
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Checkbox(value: false, onChanged: null,checkColor: Colors.orange,),
                ),
                Text('Remember me', style: TextStyle(color: Colors.orange, fontSize: 16),)
              ],
            ),
            Padding(
